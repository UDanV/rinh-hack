...
export default function FormCreateApplication({ navigation }) {
    ...
    const [monthly_inhand_salary, setMonthly_inhand_salary] = useState({value: '', error: ''})
    const [num_bank_accounts, setNum_bank_accounts] = useState({value: '', error: ''})
    const [num_credit_card, setNum_credit_card] = useState({value: '', error: ''})
    const [num_of_loan, setNum_of_loan] = useState({value: '', error: ''})
    const [num_credit_inquiries, setNum_credit_inquiries] = useState({value: '', error: ''})
    const [credit_history_age, setCredit_history_age] = useState({value: '', error: ''})
    const [amount_invested_monthly, setAmount_invested_monthly] = useState({value: '', error: ''})
    const [payment_behaviour, setPayment_behaviour] = useState({value: '', error: ''})
    const [monthly_balance, setMonthly_balance] = useState({value: '', error: ''})
                ...
                <ScrollView>
                    ...
                    <Card containerStyle={{marginTop: 35, borderRadius: 15}}>
                        ...
                        <TextInput
                            ...
                            onChangeText={(text) => setAnnual_income({value: text, error: ''})}
                        ...
                        <TextInput
                            ...
                            onChangeText={(text) => setMonthly_inhand_salary({value: text, error: ''})}
                        ...
                        <TextInput
                            ...
                            onChangeText={(text) => setNum_bank_accounts({value: text, error: ''})}
                        ...
                        <TextInput
                            ...
                            onChangeText={(text) => setNum_credit_card({value: text, error: ''})}
                        ...
                        <TextInput
                            ...
                            onChangeText={(text) => setNum_credit_inquiries({value: text, error: ''})}
                        ...
                        <TextInput
                            ...
                            onChangeText={(text) => setCredit_history_age({value: text, error: ''})}
                        ...
                        <TextInput
                            ...
                            onChangeText={(text) => setAmount_invested_monthly({value: text, error: ''})}
                        ...
                        <TextInput
                            ...
                            onChangeText={(text) => setPayment_behaviour({value: text, error: ''})}
                        ...
                        <TextInput
                            ...
                            onChangeText={(text) => setMonthly_balance({value: text, error: ''})}
